 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.trace.simple.impl.RuntimeValueImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RuntimeValueImpl extends MinimalEObjectImpl.Container implements RuntimeValue {
		...
		if (feature != null && feature.eIsProxy()) {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimplePackage.RUNTIME_VALUE__FEATURE,
							oldFeature, feature));
			}
		}
		return feature;
	...
	public void setFeature(EStructuralFeature newFeature) {
		...
		feature = newFeature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplePackage.RUNTIME_VALUE__FEATURE, oldFeature,
					feature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SimplePackage.RUNTIME_VALUE__FEATURE:
			if (resolve)
				return getFeature();
