...
public class SimpleAdapterFactory extends AdapterFactoryImpl {
	...
	protected SimpleSwitch<Adapter> modelSwitch = new SimpleSwitch<Adapter>() {
		...
		@Override
		public Adapter caseRuntimeCollection(RuntimeCollection object) {
			return createRuntimeCollectionAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.gemoc.trace.simple.RuntimeCollection <em>Runtime Collection</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRuntimeCollectionAdapter() {
		return null;
	}
